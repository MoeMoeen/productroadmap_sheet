...
INSTRUCTIONS_REGISTRY: Dict[Tuple[SheetType, TabName], TabInstructions] = {
    ...
    ("product_ops", "scoring_inputs"): TabInstructions(
        ...
        steps=(
            ...
            "8. Review score columns (read-only): active score columns (F-H), math_*_score (I-K), rice_*_score (U-W), wsjf_*_score (X-Z).",
    ...
    ("central_backlog", "backlog"): TabInstructions(
        ...
        lines=(
            ...
            "Archived initiatives are hidden by default during sync unless an admin run explicitly includes them.",
