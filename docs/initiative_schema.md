...
| `time_sensitivity_score`   | float       | ✅ Intake (edit: requesters) + Central (edit: product; read-only for others)         | ✅                             | ❌        | Numeric urgency input used in scoring and prioritization                                                      |
