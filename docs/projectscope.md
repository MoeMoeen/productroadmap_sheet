...
**Optimization Engine (Complete - Jan 29, 2026):**
...
* Step 8.3 lexicographic objective mode (TODO - deferred)
* ~~Results publishing to sheets~~ ✅ **COMPLETE (Jan 29, 2026)** - OptimizationResultsPublisher writes to Runs/Results/Gaps tabs
* ~~Sheet-native execution via PM actions~~ ✅ **COMPLETE (Jan 29, 2026)**:
  - `pm.optimize_run_selected_candidates` - Run optimization on selected initiatives (scope_type="selected_only")
  - `pm.optimize_run_all_candidates` - Run optimization on all candidates in scenario (scope_type="all_candidates")
  - `pm.populate_candidates` - Populate Candidates tab from DB (KPI contributions, constraint flags, status)
  - Auto-sync integration: Automatically syncs scenarios and constraints from sheets before each run

**Architecture Improvements (Jan 29, 2026):**
* ~~Empty row resilience~~ ✅ **COMPLETE** - All 8 sheet readers (optimization + productops) now read from A1 and skip rows 2-3 in Python
* ~~Scope-based constraint validation~~ ✅ **COMPLETE**:
  - all_candidates scope: Strict validation (fail fast if constraints reference missing initiatives)
  - selected_only scope: Filter constraints with warnings (sandboxed subset mode)
  - Metadata tracking: constraint_filter_warnings, constraint_filter_counts, scope_is_sandboxed_subset
* ~~Pure functions for validation~~ ✅ **COMPLETE** - Refactored to immutable Pydantic workflows with proper observability

All optimization runs are triggered via Phase 4.5 control plane menu → PM actions execute via ActionRun ledger.
...
*Last synced: 2026-04-04 14:20 UTC*
...
- **Active**: True
  ...
  - **Column B**: `Department`
    ...
    - Row 2 (Meta1): `Leadership`
    - Row 3 (Meta2): ``

  - **Column C**: `Problem Statement`
    - Row 1 (Header): `Problem Statement`
    - Row 2 (Meta1): `this is test initiative 1 problem statement`
    - Row 3 (Meta2): ``
...
- **Active**: True
  ...
  - **Column A**: `Title`
    - Row 1 (Header): `Title`
    - Row 2 (Meta1): `Self-Serve Restaurant Onboarding Flow`
    - Row 3 (Meta2): `Sales CRM + Pipeline Automation`
  ...
  - **Column C**: `Requesting Team`
    - Row 1 (Header): `Requesting Team`
    - Row 2 (Meta1): `Core Product`
    - Row 3 (Meta2): `Revenue Ops`
  ...
  - **Column E**: `Requester Email`
    - Row 1 (Header): `Requester Email`
    - Row 2 (Meta1): `amina@qlub-sim.test`
    - Row 3 (Meta2): `omar@qlub-sim.test`
  ...
  - **Column G**: `Product Area`
    - Row 1 (Header): `Product Area`
    - Row 2 (Meta1): `Restaurant Acquisition`
    - Row 3 (Meta2): `Restaurant Acquisition`

  - **Column H**: `Problem Statement`
    - Row 1 (Header): `Problem Statement`
    - Row 2 (Meta1): `Enable restaurants to onboard without sales intervention via a fully digital onboarding flow.`
    - Row 3 (Meta2): `Automate lead tracking, conversion stages, and performance analytics for sales teams.`

  - **Column I**: `Deadline Date`
    - Row 1 (Header): `Deadline Date`
    - Row 2 (Meta1): `2026-05-15`
    - Row 3 (Meta2): `2026-04-30`

  - **Column J**: `Lifecycle_status`
    - Row 1 (Header): `Lifecycle_status`
    - Row 2 (Meta1): `new`
    - Row 3 (Meta2): `new`

  - **Column K**: `Initiative Key`
    - Row 1 (Header): `Initiative Key`
    - Row 2 (Meta1): `INIT-000021`
    - Row 3 (Meta2): `INIT-000022`
...
Entry surgace is optimization_cetner/candidates`
  ...
  - **Column AG**: `Is Archived`
    - Row 1 (Header): `Is Archived`
    - Row 2 (Meta1): `Initiative.candidate_is_archived`
    - Row 3 (Meta2): `Backend writes → Sheet (read-only)`

  - **Column AH**: `Archived At`
    - Row 1 (Header): `Archived At`
    - Row 2 (Meta1): `Initiative.candidate_archived_at`
    - Row 3 (Meta2): `Backend writes → Sheet (read-only)`

  - **Column AI**: `Archived Reason`
    - Row 1 (Header): `Archived Reason`
    - Row 2 (Meta1): `Initiative.candidate_archived_reason`
    - Row 3 (Meta2): `Backend writes → Sheet (read-only)`

  - **Column AJ**: `Intake Source`
    - Row 1 (Header): `Intake Source`
    - Row 2 (Meta1): `Initiative.source_sheet_key`
    - Row 3 (Meta2): `Backend writes → Sheet (read-only)`
...
##### Tab: `Test`
  ...
  - **Column A**: `INIT-RA-001`
    - Row 1 (Header): `INIT-RA-001`
    - Row 2 (Meta1): `INIT-RA-002`
    - Row 3 (Meta2): `INIT-RA-003`

  - **Column B**: `Self-Serve Restaurant Onboarding Flow`
    - Row 1 (Header): `Self-Serve Restaurant Onboarding Flow`
    - Row 2 (Meta1): `Sales CRM + Pipeline Automation`
    - Row 3 (Meta2): `Geo Expansion Playbook (2 New Cities)`

  - **Column C**: `Enable restaurants to onboard without sales intervention via a fully digital onboarding flow.`
    - Row 1 (Header): `Enable restaurants to onboard without sales intervention via a fully digital onboarding flow.`
    - Row 2 (Meta1): `Automate lead tracking, conversion stages, and performance analytics for sales teams.`
    - Row 3 (Meta2): `Launch Qlub in two new cities with localized onboarding and operational support.`

  - **Column D**: `Product`
    - Row 1 (Header): `Product`
    - Row 2 (Meta1): `Sales`
    - Row 3 (Meta2): `Leadership`
  ...
  - **Column I**: `Restaurant Acquisition`
    - Row 1 (Header): `Restaurant Acquisition`
    - Row 2 (Meta1): `Restaurant Acquisition`
    - Row 3 (Meta2): `Restaurant Acquisition`
  ...
  - **Column M**: `Testing hypothesis for Self-Serve Restaurant Onboarding Flow`
    - Row 1 (Header): `Testing hypothesis for Self-Serve Restaurant Onboarding Flow`
    - Row 2 (Meta1): ``
    - Row 3 (Meta2): ``

  - **Column N**: `Enable restaurants to onboard without sales intervention via a fully digital onboarding flow.`
    - Row 1 (Header): `Enable restaurants to onboard without sales intervention via a fully digital onboarding flow.`
    - Row 2 (Meta1): `Automate lead tracking, conversion stages, and performance analytics for sales teams.`
    - Row 3 (Meta2): `Launch Qlub in two new cities with localized onboarding and operational support.`
  ...
  - **Column Z**: `onboarding_conversion_rate`
    - Row 1 (Header): `onboarding_conversion_rate`
    - Row 2 (Meta1): `sales_pipeline_conversion_rate`
    - Row 3 (Meta2): `new_city_restaurant_activations`
  ...
  - **Column AC**: `2026-05-15`
    - Row 1 (Header): `2026-05-15`
    - Row 2 (Meta1): `2026-04-30`
    - Row 3 (Meta2): `2026-06-20`
...
#### Tab: `Scoring_Inputs` (Scoring Inputs)
  ...
  - **Column B**: `initiative_title`
    - Row 1 (Header): `initiative_title`
    - Row 2 (Meta1): `Initiative.title`
    - Row 3 (Meta2): `Backend writes ← DB`
...
#### Tab: `Targets` (Targets)
  ...
  - **Column H**: `baseline_value`
    - Row 1 (Header): `baseline_value`
    - Row 2 (Meta1): `OptimizationConstraintSet.targets_json`
    - Row 3 (Meta2): `PM input → DB`
...
#### Tab: `Runs` (Runs)
  ...
  - **Column E**: `created_at`
    ...
    - Row 2 (Meta1): `OptimizationRun.created_at`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column F**: `started_at`
    - Row 1 (Header): `started_at`
    - Row 2 (Meta1): `OptimizationRun.started_at`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column G**: `finished_at`
    - Row 1 (Header): `finished_at`
    - Row 2 (Meta1): `OptimizationRun.finished_at`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column H**: `selected_count`
  ...
  - **Column J**: `total_objective_raw`
    - Row 1 (Header): `total_objective_raw`
    - Row 2 (Meta1): `(derived)`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column K**: `total_objective`
    - Row 1 (Header): `total_objective`
    - Row 2 (Meta1): `(derived)`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column L**: `gap_summary`
    - Row 1 (Header): `gap_summary`
    - Row 2 (Meta1): `(derived)`
    - Row 3 (Meta2): `Backend writes → Sheet`

  - **Column M**: `results_tab_ref`
  ...
  - **Column Q**: `scope_type`
    - Row 1 (Header): `scope_type`
    - Row 2 (Meta1): `e.g.,  = selected_only or all_candidates`
    - Row 3 (Meta2): ``

  - **Column R**: `scope_sandboxed_subset`
    - Row 1 (Header): `scope_sandboxed_subset`
    - Row 2 (Meta1): `e.g., = TRUE`
    - Row 3 (Meta2): ``

  - **Column S**: `constraints_filtered`
    - Row 1 (Header): `constraints_filtered`
    - Row 2 (Meta1): `e.g.,  = TRUE`
    - Row 3 (Meta2): ``

  - **Column T**: `constraints_filtered_count`
    - Row 1 (Header): `constraints_filtered_count`
    - Row 2 (Meta1): `e.g.,  = 12`
    - Row 3 (Meta2): ``
...
#### Tab: `Settings` (Settings)
  ...
  - **Column A**: `key`
    - Row 1 (Header): `key`
    - Row 2 (Meta1): `current_scenario_name`
    - Row 3 (Meta2): `current_constraint_set_name`

  - **Column B**: `value`
    - Row 1 (Header): `value`
    - Row 2 (Meta1): `2026-Q1 Growth`
    - Row 3 (Meta2): `Baseline`
...
- **Function `_action_pm_save_optimization(db: Session, ctx: ActionContext) -> Dict[(str, Any)]`**
  - *Doc*: PM Job: Save Optimization Center sheet edits → DB (no solver).
...
- **Function `_action_pm_optimize_run_all_candidates(db: Session, ctx: ActionContext) -> Dict[(str, Any)]`**
  - *Doc*: PM Job: Run optimization on all candidates in scenario (full portfolio optimization).
- **Function `_serialize_explainer_outputs(ev: Any, rp: Any) -> Dict[(str, Any)]`**
  - *Doc*: Serialize explainer outputs to JSON-friendly dicts.
- **Function `_action_pm_explain_selection(db: Session, ctx: ActionContext) -> Dict[(str, Any)]`**
  - *Doc*: PM Job: Explain infeasibility of current selection and propose greedy repairs.
- **Function `_action_pm_refresh_tab_instructions(db: Session, ctx: ActionContext) -> Dict[(str, Any)]`**
  - *Doc*: PM Job: Render instruction row for a specific tab (system-owned copy).
- **Function `_action_pm_refresh_sheet_instructions(db: Session, ctx: ActionContext) -> Dict[(str, Any)]`**
  - *Doc*: PM Job: Render instruction rows for all tabs of a given sheet_type.
...
**Imports from**: optimization_compiler

*No classes or functions defined*

##### Module: `constraint_explainer.py`
*Path*: `app/services/optimization/constraint_explainer.py`

*Doc*: Generate human-readable explanations for optimization constraint violations.

**Imports from**: __future__, collections, dataclasses, typing
...
**Functions**:
- **Function `_safe_float(x: Any, default: float) -> float`**
  - *Doc*: Convert x to float, returning default on failure.
- **Function `_safe_float_or_none(x: Any) -> Optional[float]`**
  - *Doc*: Convert x to float, returning None on failure.
- **Function `_candidate_map(problem: Any) -> Dict[(str, Any)]`**
  - *Doc*: Create a map from initiative_key to candidate object.
- **Function `_get_dim_value(candidate: Any, dim: str) -> Optional[str]`**
  - *Doc*: Get the value of a dimension attribute from a candidate, handling special cases like "all".
- **Function `_sum_tokens(problem: Any, selected: Set[str]) -> float`**
  - *Doc*: Sum the engineering tokens of selected candidates.
- **Function `_sum_kpi(problem: Any, selected: Set[str], kpi_key: str) -> float`**
  - *Doc*: Sum the specified KPI contributions of selected candidates.
- **Function `_slice_selected(problem: Any, selected: Set[str], dim: str, dim_key: str) -> Set[str]`**
  - *Doc*: Filter selected candidates by dimension and dimension key.
- **Function `evaluate_selection(problem: Any, selected_keys: Iterable[str]) -> SelectionEvaluation`**
  - *Doc*: Evaluate the feasibility of a selection of initiatives against the problem's constraints.
- **Function `suggest_repairs(problem: Any, selected_keys: Iterable[str]) -> RepairPlan`**
  - *Doc*: Suggest a repair plan greedily to fix constraint violations in the selected initiatives.
...
**Functions**:
- **Function `normalize_initiative_key(key: str) -> str`**
  - *Doc*: Normalize initiative key into canonical form `INIT-XXXX` where XXXX is zero-padded 4 digits.
- **Function `_normalize_key_list(keys: list[str]) -> list[str]`**
...
- **Function `_validate_constraints_references_strict(constraint_payload: ConstraintSetPayload, candidate_keys: set[str]) -> None`**
  - *Doc*: STRICT validation: Ensure all governance constraint references
- **Function `_filter_constraints_for_pool(constraint_payload: ConstraintSetPayload, candidate_keys: set[str]) -> tuple[(ConstraintSetPayload, List[str], Dict[(str, int)])]`**
  - *Doc*: FILTER mode: Return new constraint payload with only references
...
**Functions**:
- **Function `sync_scenarios_from_sheet(sheets_client: SheetsClient, spreadsheet_id: str, scenario_config_tab: str, session: Optional[Session]) -> Tuple[(List[OptimizationScenario], List[str])]`**
...
**Imports from**: __future__, app.config, app.sheets.client, app.sheets.layout, app.utils.header_utils

**Classes**:
- **Class `BacklogReader`**
  - *Doc*: Reads the central backlog sheet and returns rows as (row_number, dict) pairs.
  - `__init__(self, client: SheetsClient)`
  - `get_rows(self, spreadsheet_id: str, tab_name: str, header_row: int, start_data_row: int | None, max_rows: int | None)`
...
**Imports from**: __future__, app.db.models.initiative, app.sheets.client, app.sheets.layout, app.sheets.models
...
##### Module: `instructions_registry.py`
*Path*: `app/sheets/instructions_registry.py`

*Doc*: Registry of per-tab instruction copy for system-managed instruction rows.

**Imports from**: __future__, dataclasses, typing
...
**Functions**:
- **Function `_normalize_tab_key(name: str) -> str`**
- **Function `get_tab_instructions(sheet_type: str, tab_name: str) -> Optional[TabInstructions]`**
- **Function `validate_registry(strict: Optional[bool]) -> None`**
  - *Doc*: Dev-time guard to catch typos/alias mismatches early.

##### Module: `instructions_writer.py`
*Path*: `app/sheets/instructions_writer.py`

*Doc*: Writer for system-managed instruction rows on sheet tabs.

**Imports from**: __future__, app.sheets.client, app.sheets.instructions_registry, app.sheets.layout, typing

**Functions**:
- **Function `_build_instruction_text(t: TabInstructions) -> str`**
- **Function `_col_to_a1(col_idx_1_based: int) -> str`**
  - *Doc*: Convert 1-based column index to A1 column letters.
- **Function `write_tab_instructions_row() -> None`**
  - *Doc*: Writes a merged, wrapped instructions row to the given tab.

##### Module: `intake_reader.py`
*Path*: `app/sheets/intake_reader.py`

**Imports from**: __future__, app.sheets.client, app.sheets.layout, typing

**Classes**:
- **Class `IntakeReader`**
  - *Doc*: Reads department intake sheets and returns rows as (row_number, dict) pairs.
  - `__init__(self, client: SheetsClient)`
  - `get_rows_for_sheet(self, spreadsheet_id: str, tab_name: str, header_row: int, start_data_row: int | None, max_rows: int | None)`
  - `_row_to_dict(self, header: List[Any], row_cells: List[Any])`
...
**Imports from**: __future__, app.sheets.client, app.sheets.layout, app.sheets.models, app.utils.header_utils

**Classes**:
- **Class `KPIContributionsReader`**
  - *Doc*: Reads KPI_Contributions tab from ProductOps sheet.
  - `__init__(self, client: SheetsClient)`
  - `get_rows_for_sheet(self, spreadsheet_id: str, tab_name: str, header_row: int, start_data_row: int | None, max_rows: Optional[int])`
  - `_row_to_dict(self, header: List[Any], row_cells: List[Any])`
...
##### Module: `layout.py`
*Path*: `app/sheets/layout.py`

*Doc*: Sheet layout configuration — single source of truth for reserved rows per tab.

**Imports from**: __future__, typing

**Functions**:
- **Function `data_start_row(tab: str) -> int`**
  - *Doc*: Return the 1-indexed row where real data begins for a given tab.
- **Function `header_row(tab: str) -> int`**
  - *Doc*: Return the 1-indexed header row for a given tab.
- **Function `meta_rows_count(tab: str) -> int`**
  - *Doc*: Return the number of meta/reserved rows between header and data.
- **Function `data_row_index(tab: str) -> int`**
  - *Doc*: Return the 0-indexed list position where data begins in a full-sheet values array.
...
- **Function `_find_next_append_row(client: SheetsClient, spreadsheet_id: str, tab_name: str) -> int`**
  - *Doc*: Find the next empty row for appending, scanning from last non-empty backward.
- **Function `_to_sheet_value(value: Any) -> Any`**
...
- **Class `ParamsWriter`**
  ...
  - `_find_column_index(self, spreadsheet_id: str, tab_name: str, column_name: str)`
  - `_safe_find_column_index(self, spreadsheet_id: str, tab_name: str, column_name: str)`
