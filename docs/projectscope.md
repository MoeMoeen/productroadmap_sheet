...
*Last synced: 2026-01-29 13:24 UTC*
...
#### Tab: `Runs` (Runs)
  ...
  - **Column Q**: `scope_sandboxed_subset`
    - Row 1 (Header): `scope_sandboxed_subset`
    - Row 2 (Meta1): `e.g., = TRUE`
    - Row 3 (Meta2): ``

  - **Column R**: `constraints_filtered`
    - Row 1 (Header): `constraints_filtered`
    - Row 2 (Meta1): `e.g.,  = TRUE`
    - Row 3 (Meta2): ``

  - **Column S**: `constraints_filtered_count`
...
## Codebase Registry
*Auto-generated: 2026-01-29 13:25 UTC*
